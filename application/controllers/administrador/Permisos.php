...
class Permisos extends CI_Controller {
	...
	public function store(){
		...
		if($this->Permisos_model->save($data)){
			...
			$this->session->set_flashdata("error", "No se puedo guardar la información");
			$this->redirect(base_url)."administrador/permisos/add";
		}
	...
	public function update(){
		...
		if($this->Permisos_model->update($idpermiso, $data)){
			...
			$this->session->set_flashdata("error", "No se puedo guardar la información");
			$this->redirect(base_url)."administrador/permisos/edit/".$idpermiso;
		}
