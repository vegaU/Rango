                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/store" method="POST">
                            ...
                            <div class="form-group <?php echo !empty(form_error('precioxMayor')) ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="precioxMayor" name="precioxMayor" value="<?php echo set_value('precioxMayor');?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error('precioxCantidad')) ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="precioxCantidad" name="precioxCantidad" value="<?php echo set_value('precioxCantidad');?>">
