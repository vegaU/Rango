                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/update" method="POST">
                            ...
                            <div class="form-group <?php echo !empty(form_error('precioxMayor')) ? 'has-error':'';?>">
                                <label for="precioxMayor">Precio x Mayor:</label>
                                <input type="text" class="form-control" id="precioprecioxMayor" name="precioxMayor" value="<?php echo !empty(form_error('precioxMayor')) ? set_value('precioxMayor'):$producto->precioxMayor?>">
                                <?php echo form_error("precioxMayor","<span class='help-block'>","</span>");?>
                            </div>
                            <div class="form-group <?php echo !empty(form_error('precioxCantidad')) ? 'has-error':'';?>">
                                <label for="precioxCantidad">Precio x Cantidad:</label>
                                <input type="text" class="form-control" id="precioxCantidad" name="precioxCantidad" value="<?php echo !empty(form_error('precioxCantidad')) ? set_value('precioxCantidad'):$producto->precioxCantidad?>">
                                <?php echo form_error("precioxCantidad","<span class='help-block'>","</span>");?>
                            </div>
                            ...
                            <div class="form-group <?php echo !empty(form_error('color')) ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="color" name="color" value="<?php echo !empty(form_error('color')) ? set_value('color'):$producto->color?>">
                                ...
                                <select name="marca" id="marca" class="form-control">
                                    <?php foreach($marcas as $marca):?>
                                        <?php if($marca->id == $producto->marca_id):?>
                                            <option value="<?php echo $marca->id?>" selected><?php echo $marca->marca;?></option>
                                        <?php else:?>
